...
export default function Items() {
  ...
  return (
    <div className='h-[400vh] w-screen md:p-10 p-5 bg-[#1a1b1c] flex flex-col items-center'>
        ...
        <div  className='md:h-[60vh] h-[70vh] w-full flex flex-col-reverse md:flex-row justify-between py-3 mb-25'>
        ...
        <div  className='h-[60vh] w-full flex flex-col md:flex-row  justify-between py-3 mb-25'>
            <div className='flex flex-col items-center w-[35%] h-full'><img src={food3} alt="food-1" className='h-[60vh]' /></div>
